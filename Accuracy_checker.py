...
'''
Retrieves tweets from the specified url and loads them in json
'''
def retrieveTweet(data_url):
 ...
 '''
 retrieve the processed tweetw and and appends them in a graph
 '''            
...
'''
using naive  bayes the data is trained and the accuracy and speed of the algorithm is outputted
'''         
def nbTrain():
...
'''
using decision tree the data is trained and the accuracy and speed of the algorithm is outputted
'''
def datree():
...
'''
using support vector machine the data is trained and the accuracy and speed of the algorithm is outputted
'''
def Tsvm():
...
'''
using K neighbours classifier the data is trained and the accuracy and speed of the algorithm is outputted
'''
def knN():
...
'''
using random forest the data is trained and the accuracy and speed of the algorithm is outputted
'''
def RanFo():
